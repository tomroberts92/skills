...
4. **Reply to every thread explicitly.** State what you changed and where, or, if you disagree, the reason, candidly. For out-of-scope items, link a follow-up ticket rather than expanding the PR. Write replies in your own voice per `../references/pr-comment-voice.md` (the reply not the conversation, no reassurance padding).
